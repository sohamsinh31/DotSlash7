...
import { analyzeCode, analyzeCodeForFunctions, createGraphData } from '@/Services/CodeT';
...
import Stack from "@/Components/Stack/Stack"; // Import Stack component
import './Demo.css';
...
export const TestA: React.FC = () => {
    ...
    const handleRunButtonClick = async () => {
        ...
        // Extract function names from FunctionInfo array
        const functionCalls = analyzeCodeForFunctions(code).map((info) => info.functionName);
        setExecutionStack(functionCalls);
    };
    return (
